...
local Stat = PepsiUi:CreateTab({
    Name = "Status"
})

local Plr = PepsiUi:CreateTab({
    Name = "Players"
})
...
local ShopL2 = Shop:CreateSection({
	Name = "Orther",
	Side = "Left"
})

local ShopL3 = Shop:CreateSection({
	Name = "Fighting Style",
	Side = "Left"
})

local ShopL4 = Shop:CreateSection({
	Name = "Accessorys",
	Side = "Left"
})

local ShopR1 = Shop:CreateSection({
	Name = "Abilities",
	Side = "Right"
})

local ShopR2 = Shop:CreateSection({
	Name = "Swords",
	Side = "Right"
})

local ShopR3 = Shop:CreateSection({
	Name = "Guns",
	Side = "Right"
})
...
local DropBoss = MainL1:AddDropdown({
	Name = "Select Boss",
	Value = "",
	List = BossList,
	Callback = function(value)
...
local DropTool = MainR1:AddDropdown({
	Name = "Select Weapon",
	Value = "",
	List = WeaponList,
	Callback = function(value)
